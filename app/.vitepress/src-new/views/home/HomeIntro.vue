...
const introData = computed(() => homeContent[locale.value].intro);

const imgSrc = computed(() => {
  return lePadV.value
    ? introData.value[active.value].img_mo
    : introData.value[active.value].img_pc;
});
  ...
  >
    <div class="intro-container" :level-index="1" ref="container">
            ...
            >
              ...
              >
                <div class="intro-list-icon">
                  <img :src="theme === 'light' ? item.icon_light : item.icon_dark" alt="" />
                  <img
                    class="circle"
      ...
      >
        ...
        >
          <template #title>
            <img :src="theme === 'light' ? item.icon_light : item.icon_dark" alt="" /> {{ item.title }}
          </template>
