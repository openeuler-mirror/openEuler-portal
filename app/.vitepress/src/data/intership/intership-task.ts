export default {
  ...
  EULER_TASK_ITEM: [
    ...
    {
      NAME: 'sig-QA',
      NAME_LINK: 'https://www.openeuler.org/zh/sig/sig-QA',
    ...
    {
      NAME: 'sig-openstack',
      NAME_LINK: 'https://www.openeuler.org/zh/sig/sig-openstack',
      INTRODUCE:
      ...
      GITEE: 'https://atomgit.com/openeuler/openstack',
    },
    {
      NAME: 'A-tune',
      NAME_LINK: 'https://www.openeuler.org/zh/sig/A-Tune',
    ...
    },
    {
      ...
      NAME_LINK: 'https://www.openeuler.org/zh/sig/sig-KIRAN-DESKTOP',
      INTRODUCE:
      ...
      GITEE:
        'https://atomgit.com/openeuler/community/tree/master/sig/sig-KIRAN-DESKTOP',
    },
    {
      NAME: 'sig-ops',
      NAME_LINK: 'https://www.openeuler.org/zh/sig/sig-ops',
    ...
    {
      NAME: 'Cloud Native',
      NAME_LINK: 'https://www.openeuler.org/zh/sig/sig-CloudNative',
      INTRODUCE:
      ...
      GITEE:
        'https://atomgit.com/openeuler/community/tree/master/sig/sig-CloudNative',
    },
    {
      NAME: 'G11N',
    ...
    {
      NAME: 'sig-UKUI',
      NAME_LINK: 'https://www.openeuler.org/zh/sig/sig-UKUI',
      INTRODUCE:
    ...
    {
      NAME: 'sig-OSCourse',
      NAME_LINK: 'https://www.openeuler.org/zh/sig/sig-OSCourse',
      ...
      GITEE:
        'https://atomgit.com/openeuler/community/tree/master/sig/sig-OSCourse',
    },
    {
      NAME: 'sig-DDE',
    ...
    {
      NAME: 'Infrastructure',
      NAME_LINK: 'https://www.openeuler.org/zh/sig/Infrastructure',
      ...
      GITEE:
        'https://atomgit.com/openeuler/community/tree/master/sig/Infrastructure',
    },
    {
      NAME: 'sig-OS-Builder',
      NAME_LINK: 'https://www.openeuler.org/zh/sig/sig-OS-Builder',
      INTRODUCE:
    ...
    },
    {
      ...
      GITEE: 'https://atomgit.com/openeuler/community/tree/master/sig/sig-CICD',
    },
    {
      NAME: 'sig-HPC',
      ...
      GITEE: 'https://atomgit.com/openeuler/community/tree/master/sig/sig-HPC',
    },
    {
      NAME: 'sig-Virt',
      ...
      GITEE: 'https://atomgit.com/openeuler/community/tree/master/sig/Virt',
    },
    {
      NAME: 'sig-Compatibility-Infra',
      NAME_LINK: 'https://www.openeuler.org/zh/sig/sig-Compatibility-Infra',
      ...
      GITEE:
        'https://atomgit.com/openeuler/community/tree/master/sig/sig-Compatibility-Infra',
    },
    {
      NAME: 'Compiler',
      ...
      GITEE: 'https://atomgit.com/openeuler/community/tree/master/sig/Compiler',
    },
    {
      NAME: 'AI SIG',
      ...
      GITEE: 'https://atomgit.com/openeuler/community/tree/master/sig/ai',
    },
    {
      NAME: 'sig-BigData',
      ...
      GITEE: 'https://atomgit.com/openeuler/community/tree/master/sig/bigdata',
    },
    {
      NAME: 'sig-SDS',
    ...
    },
    {
      ...
      GITEE:
        'https://atomgit.com/openeuler/community/tree/master/sig/sig-AccLib',
    },
    {
      NAME: 'sig-FangTian',
      NAME_LINK: 'https://www.openeuler.org/zh/sig/sig-FangTian',
      INTRODUCE:
    ...
    {
      NAME: 'sig-memsafety',
      NAME_LINK: 'https://www.openeuler.org/zh/sig/sig-memsafety',
      INTRODUCE: '借助编程语言的特点，打造内存更为安全的开源项目',
      TASK: 'https://atomgit.com/openeuler/easybox/issues',
      GITEE:
        'https://atomgit.com/openeuler/community/tree/master/sig/sig-memsafety',
    },
    {
      NAME: 'sig-dev-utils',
      ...
      GITEE:
        'https://atomgit.com/openeuler/community/tree/master/sig/dev-utils',
    },
    {
      NAME_LINK: '',
