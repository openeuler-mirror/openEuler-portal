...
export default {
  ...
  COPYRIGHT_1:
    '[Copyright] Copyright © 2024 openEuler Community. This article is first released by the openEuler community. Please reproduce it in compliance with the',
  COPYRIGHT_2:
