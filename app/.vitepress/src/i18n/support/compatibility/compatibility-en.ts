export default {
  ...
  DRIVE_SEARCH_PLACEHOLDER:'Driver name, card model, chip vendor, or chip model',
  ...
  HARDWARE_DETAIL: {
    ...
    TIP_LABEL:'This configuration has been verified for compatibility. For details about different configurations, see',
  ...
  HARDWARE_OEC_DETAIL: {
    ...
    ITEM_ARR: [
      ...
      },
      {
        ...
        DESCRIPTION_1: 'After signing the agreement, create an issue under the oec-hardware project (',
  ...
  SOFTWARE_OEC_DETAIL: {
    ...
    TITLE:'Overall Introduction to the openEuler Compatibility Technical Assessment',
    DISCRIPTION_TITLE: 'Introduction',
    DISCRIPTION_CONTENT:
    ...
    ITEM_ARR: [
      ...
      },
      {
        ...
        DESCRIPTION_2:'automated testing platform and user guide to help you complete the test.',
      },
      {
        ID: '03',
