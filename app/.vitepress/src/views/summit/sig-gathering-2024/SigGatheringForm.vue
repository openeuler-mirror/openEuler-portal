  ...
  <AppContent :pc-top="40" :mobile-top="12">
    ...
    <div class="form" v-else>
      ...
      >
        ...
        <el-form-item label="您在openeuler社区的哪个SIG组参与贡献" prop="sigs">
          <OSelect
        ...
        <el-form-item label="您计划参与的技术研讨专场" prop="technicalSeminars">
      ...
      <div v-else-if="loginStatus === 'NOT_LOGIN'" class="auth-box">
        <OButton v-if="showPage" type="primary" @click="showGuard()">
          请先登录后，再填写
        </OButton>
      </div>
    </div>
