...
export default {
  ...
  introduce:
    '数字经济成为全球经济增长的主引擎，数字经济的快速发展，带来数字化、智能化的巨大发展机遇。 AI作为引领技术的新引擎，驱动着创新与进步。作为数字基础设施的底座以及连接和驱动AI技术的桥梁，操作系统的发展为实现智能社会提供了无限可能。操作系统产业大会2023旨在聚集全产业链乃至海内外的力量，聚焦基础软件核心能力构建，引领基础软件技术持续创新，共建全球开源共同体，推动智能化操作系统在数字化时代的发展，共辟未来数字化世界的发展新征程。',
  introduce2:
