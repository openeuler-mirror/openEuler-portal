...
凡是包含**由 AI 核心生成或经 AI/Agent 自动化处理**的代码与文档，在提交 Pull Request 时必须完整记录并携带以下**关键元数据**。这些元数据可记录在 Pull Request 的固定模版中：

* **Agent平台 (Tool)**：明确指明生成该内容所使用的Agent平台名称及版本（如 `Cluade Code 2.1.156`, `Qwen Code 0.16.1` 等）。
