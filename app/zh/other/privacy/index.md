...
**i) 快速提交 issue**，当您通过社区的 QuickIssue 服务进行邮箱验证以提交 issue 时，我们会向您输入的邮箱发送验证邮件，用以验证邮箱的有效性；issue 成功创建后，我们会在该 issue 页面的描述信息以及 QuickIssue 的 issue 看板的提交者展示您邮箱的部分信息；当issue产生评论或状态变更时，我们会邮件通知您的校验邮箱。
