...
**(a) Account Service**.
  ...
  5. After logging in, you can modify your **email address, mobile number, and password**, we will collect **the provided credentials and verification code** for authentication.
